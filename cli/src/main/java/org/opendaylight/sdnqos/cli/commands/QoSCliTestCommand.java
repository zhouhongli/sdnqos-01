 ...
 */
package org.opendaylight.sdnqos.cli.commands;
...
public class QoSCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(QoSCliTestCommand.class);
    protected final QoSCliCommands service;

    public QoSCliTestCommand(final QoSCliCommands service) {
